"""
extractor/walker.py — Proper bytecode walk of the LLVM MatcherTable.

Replaces the opportunistic scan() + build_switchtype_context() pair with a
single-pass recursive descent that follows the actual decision-tree structure
and propagates MVT context through OPC_SwitchType arms.
...
from karnage.extractor.extractor import MatcherEntry
